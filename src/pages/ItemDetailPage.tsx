            ...
            <Container maxWidth="lg" sx={{ py: 4, mt: 6 }}>
                ...
                <Box sx={{ display: 'flex', gap: 4, flexDirection: { xs: 'column', lg: 'row' } }}>
                    ...
                    <Box sx={{ flex: 2, minWidth: 0 }}>
                        <Card sx={{ mb: 3 }}>
                            <CardMedia component="img" height="400" image={project.images[0]} alt={project.title} sx={{ objectFit: 'cover' }} />
                        </Card>
                        ...
                        <Paper sx={{ p: 3 }}>
                            ...
                            <Box sx={{
                                ...
                                <Box>
                                    ...
                                    <Typography variant="body2" sx={{ fontSize: '0.875.rem' }}>{project.systemRequirements.browser}</Typography>
                                </Box>
                                <Box>
                                    <Typography variant="subtitle2" color="text.secondary" gutterBottom>メモリ</Typography>
                                    <Typography variant="body2" sx={{ fontSize: '0.875.rem' }}>{project.systemRequirements.memory}</Typography>
                                </Box>
                            </Box>
                        </Paper>
                    </Box>
                   ...
                   <Box sx={{ flex: 1, minWidth: 300 }}>
                       <Paper className="sticky-sidebar" sx={{ p: 3 }}>
                           ...
                           <Typography variant="body2" color="text.secondary" paragraph>{project.shortDescription}</Typography>
                           <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                               <Rating value={project.rating.average} precision={0.1} readOnly size="small" />
                               <Typography variant="caption" sx={{ ml: 1 }}>({project.rating.count}件)</Typography>
                            </Box>
                            <Box sx={{ mb: 3 }}>
                                {project.isFree
                            ...
                            <Box sx={{ mb: 2 }}>
                                ...
                                <Typography variant="body1">{project.downloadCount.toLocaleString()}</Typography>
                            </Box>
                            <Box sx={{ mb: 2 }}>
                                <Typography variant="body2" color="text.secondary">最終更新</Typography>
                                <Typography variant="body1">{project.lastUpdated}</Typography>
                            </Box>
                            <Box sx={{ mb: 2 }}>

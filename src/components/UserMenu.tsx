            ...
            >
                ...
                {isLoggedIn && (
                    <Box className={styles.userHeader}>
                        {avatarUrl ? (
                            <Avatar src={avatarUrl} alt={userName} sx={{ width: 60, height: 60 }} />
                        ) : (
                ...
                {/* ------ Menu List ------ */}                <List>
                    {isLoggedIn ? (
                        <>
                            <ListItemButton component={RouterLink} to="/my-posts" onClick={handleClose}>
                            ...
                            <ListItemButton component={RouterLink} to="/my-posts/messages" onClick={handleClose}>
                                <ListItemIcon sx={{ color: 'rgba(255,255,255,0.7)' }}>
                                ...
                                <ListItemText
                                    primary="投稿へのメッセージ"
                                    secondary={messageCount > 0 ? `${messageCount} 件未読` : undefined}
                                    secondaryTypographyProps={{ color: 'error.main' }}
                                />
                            </ListItemButton>

                            <ListItemButton component={RouterLink} to="/notifications" onClick={handleClose}>
                                <ListItemIcon sx={{ color: 'rgba(255,255,255,0.7)' }}>
                                    <Notifications />
                                </ListItemIcon>
                            ...
                            <ListItemButton component={RouterLink} to="/settings" onClick={handleClose}>
                                <ListItemIcon sx={{ color: 'rgba(255,255,255,0.7)' }}>
                                    <Settings />
                                </ListItemIcon>
                            ...
                            <ListItemButton onClick={handleLogout} className={styles.logoutButton}>
                                ...
                                <ListItemText
                                    primary="ログアウト"
                                    primaryTypographyProps={{ sx: { color: '#f44336', fontWeight: 600 } }}
                                />
                            </ListItemButton>
                        </>
                    ) : (
                        <ListItemButton component={RouterLink} to="/login" onClick={handleClose}>
                            <ListItemIcon sx={{ color: 'rgba(255,255,255,0.7)' }}>
                                <Login />
                            </ListItemIcon>
